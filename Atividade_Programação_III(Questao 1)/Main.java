public class Main {
    ...
    System.out.println("Você realizou um empréstimo: " + emp.getDadosUsuario().getNome() + ", " + emp.getLivroEmprestado().getTitulo() + ", do autor " + emp.getLivroEmprestado().getAutorLivro().getNome());
}
}
